 ...
 * @author luigicirillo
 */
public class PokemonFuoco extends Pokemon {

    public PokemonFuoco(String nome, int livello) {
        super(nome, livello);
    }
    ...
    public String toString() {
        return super.toString() + " è di tipo Fuoco";
    }

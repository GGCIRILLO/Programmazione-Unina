 ...
 * @author luigicirillo
 */
public class PokemonAcqua extends Pokemon {

    public PokemonAcqua(String nome, int livello) {
        super(nome, livello);
    }
    ...
    public void attacca(Pokemon p) {
        ...
        if ("PokemonErba".equals(p.getClass().getName())) {
    ...
    public String toString() {
        return super.toString() + " è di tipo Acqua";
    }
